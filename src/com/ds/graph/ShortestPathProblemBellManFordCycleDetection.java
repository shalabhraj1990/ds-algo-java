...
public class ShortestPathProblemBellManFordCycleDetection {
	...
	private static void bellManAlgo(List<List<Tuple2<Integer, Integer>>> adjGraph, int interation) {
